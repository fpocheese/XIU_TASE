...
bounded by the graph diameter $D$. Thus, after at most $O(ND)$ winner-propagation rounds for
all targets, all interceptors hold the same winner lists, and the disagreement metric
$\Gamma^{(k)}$ in \eqref{eq:convergence} falls below the prescribed tolerance.

The resulting assignment $\mathbf{X}^{*}$ can be interpreted as an $\epsilon$-approximate
...
\end{equation}
This equilibrium property is local and assignment-round specific. It ensures consistency and
unilateral stability of the distributed decision, but it does not imply that IDBO always
attains the globally optimal solution of \eqref{eq:optimization_formulation}. For the
...
\FOR{episode $k=1,2,\ldots$}
    ...
    \FOR{$t=0$ to $T-1$}
        \FOR{each interceptor $i$}
            ...
            Eqs.~\eqref{eq:observation_space}--\eqref{eq:o4}
...
\subfloat[Normal acceleration $n_y$]{\includegraphics[width=3.0in]{mappo_nopn_ny.png}}
\hfil
\subfloat[Heading angle $\gamma_D$]{\includegraphics[width=3.0in]{mappo_nopn_heading.png}}
\hfil
\subfloat[Velocity $V_D$]{\includegraphics[width=3.0in]{mappo_nopn_velocity.png}}
\hfil
\subfloat[Axial acceleration $n_x$]{\includegraphics[width=3.0in]{mappo_nopn_nx.png}}
\vspace{0pt}
...
\centering
\includegraphics[width=3.0in]{standalone_duav_legend.png}
\subfloat[Normal acceleration $n_y$]{\includegraphics[width=3.0in]{pn_nopn_ny.png}}
\hfil
\subfloat[Heading angle $\gamma_D$]{\includegraphics[width=3.0in]{pn_nopn_heading.png}}
\hfil
\subfloat[Velocity $V_D$]{\includegraphics[width=3.0in]{pn_nopn_velocity.png}}
\hfil
\subfloat[Axial acceleration $n_x$]{\includegraphics[width=3.0in]{pn_nopn_nx.png}}
\vspace{0pt}
...
\centering
\includegraphics[width=3.0in]{standalone_duav_legend.png}
\subfloat[Normal acceleration $n_y$]{\includegraphics[width=3.0in]{mappo_sin_ny.png}}
\hfil
\subfloat[Heading angle $\gamma_D$]{\includegraphics[width=3.0in]{mappo_sin_heading.png}}
\hfil
\subfloat[Velocity $V_D$]{\includegraphics[width=3.0in]{mappo_sin_velocity.png}}
\hfil
\subfloat[Axial acceleration $n_x$]{\includegraphics[width=3.0in]{mappo_sin_nx.png}}
\vspace{0pt}
...
\centering
\includegraphics[width=3.0in]{standalone_duav_legend.png}
\subfloat[Normal acceleration $n_y$]{\includegraphics[width=3.0in]{pn_sin_ny.png}}
\hfil
\subfloat[Heading angle $\gamma_D$]{\includegraphics[width=3.0in]{pn_sin_heading.png}}
\hfil
\subfloat[Velocity $V_D$]{\includegraphics[width=3.0in]{pn_sin_velocity.png}}
\hfil
\subfloat[Axial acceleration $n_x$]{\includegraphics[width=3.0in]{pn_sin_nx.png}}
\vspace{0pt}
...
$a_i$ & Continuous guidance action of interceptor $i$. \\
$\pi_{\theta_i}$, $V_{\phi}$ & Decentralized actor policy and centralized value function. \\
$\mathcal{T}_i$ & Trust level controlling guided exploration. \\
$r_t(\theta)$, $\hat{A}_t$ & PPO probability ratio and advantage estimate. \\
$\beta_{\mathrm{KL}}$ & Adaptive KL-penalty coefficient. \\
