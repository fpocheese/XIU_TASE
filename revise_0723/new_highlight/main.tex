...
\begin{figure*}[!t]
\centering
\includegraphics[width=7.3in]{rlsuanfa_3d_V2.pdf}
...
All training \hldel{and evaluation} were performed on an Intel Core i7-9700F CPU / Nvidia RTX 3090
...
\hladd{The third scenario is used in Section~\ref{subsec:montecarlo} to provide additional validation of the proposed method under an unseen bang--bang attack pattern.}
...
($1{,}000$~trials, $96.4\%$ ISR): $E_{co\text{-}time}$, $E_n$, $E_{miss}$,
$E_t$. }}
...
& KL estimate, penalty coefficient, and target KL divergence \\
