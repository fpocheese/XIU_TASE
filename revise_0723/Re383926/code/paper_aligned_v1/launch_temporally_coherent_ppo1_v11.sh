...
output_root=/home/a2rl/reviewer_art_mappo_paper_aligned_20260728_temporally_coherent_ppo1_v11
...
for case_name in case1 case2; do
    log_file="${output_root}/logs/full_${case_name}_seed9301.log"
    pid_file="${output_root}/logs/full_${case_name}_seed9301.pid"
