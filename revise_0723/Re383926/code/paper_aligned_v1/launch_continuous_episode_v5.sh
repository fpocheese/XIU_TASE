...
output_root=/home/a2rl/reviewer_art_mappo_paper_aligned_20260728_continuous_episode_v5
...
for case_name in case1 case2; do
    log_file="${output_root}/logs/full_${case_name}_seed9061.log"
    pid_file="${output_root}/logs/full_${case_name}_seed9061.pid"
