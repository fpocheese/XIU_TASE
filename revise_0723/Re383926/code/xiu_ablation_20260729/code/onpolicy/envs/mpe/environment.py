...
class MultiAgentEnv(gym.Env):
    ...
    def step(self, action_n, step=0):
        ...
        for agent in self.agents123:
            ...
            # Preserve the callback's structured diagnostics.  Historical
            # callers ignored the former integer flag, while the independent
            # reviewer runner uses these fields only for training-time trust
            # exploration and hit diagnostics.
