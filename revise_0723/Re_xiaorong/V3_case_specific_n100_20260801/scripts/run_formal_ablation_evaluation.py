...
def main():
    ...
    evaluator = script_root / "run_paper_nominal_eval_parallel.py"
    ...
    selection_jobs = []
    evaluation_jobs = []
    validation_seed_bases = {"case1": 96001, "case2": 96201}
    test_seed_bases = {"case1": 98401, "case2": 99401}
    for case_index, case in enumerate(CASES):
        validation_seed = validation_seed_bases[case]
        test_seed_base = test_seed_bases[case]
