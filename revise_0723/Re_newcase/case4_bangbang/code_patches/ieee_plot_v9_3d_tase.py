...
CASE_FOLDER = {
    "case1": "mappo_success_nopn",
    "case2": "mappo_success_sin",
    "case4": "mappo_success_bangbang",
}
CASE_PREFIX = {"case1": "nopn", "case2": "sin", "case4": "bangbang"}
...
def plot_v9_outputs(eval_root: Path, v9_base: Path, out: Path, v9_script: Path, dt: float):
    ...
    episodes = {}
    for case_name in ("case1", "case2", "case4"):
